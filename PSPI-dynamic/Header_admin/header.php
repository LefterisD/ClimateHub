            ...
            <div class="collapse navbar-collapse" id="navLinks">
                <ul class="navbar-nav">
                    <li class="nav-item pr-2">
                        <a href="../stakoulas/problemsAdmin.php" class="nav-link">Problems</a>
                    </li>
			        ...
			        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
			        	<a class="dropdown-item" href="../actions/admincards.php">Organizations</a>
			        	<div class="dropdown-divider"></div>
			        	<a class="dropdown-item" href="../actions2/individualactionsadmin.php">Individual Efforts</a>
					</div>
				</li>
                    <li class="nav-item pr-2">
